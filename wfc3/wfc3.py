...
ATLAS_FPATH = os.path.join( os.getcwd(), 'Kurucz/ip01k2new.pck' )
ATLAS_NEWGRID = True
ATLAS_TEFF = 4500.
ATLAS_LOGG = 4.5
...
def dataset_parameters():
    ...
    red = {}
    red['config'] = 'G102'
    red['ddir'] = os.path.join( HOMEDIR, 'data1/hst/WASP-107/G102' )
    ...
    red['crossdisp_bound_ixs'] = [ 100, 250 ]
    red['trim_disp_ixs'] = [ 60, 260 ]
    #red['shiftstretch_disp_ixs'] = [ 130, 240 ]
    red['shiftstretch_disp_ixs'] = [ 60, 240 ]
    red['bg_crossdisp_ixs'] = [ 10, 30 ]
    ...
    syspars['RpRs'] = (0.924*RJUP)/(0.657*RSUN) # planet-to-star radius ratio
    syspars['T0'] = 2457584.329746 # transit mid-time
    syspars['P'] = 5.72149242 # orbital period
    syspars['aRs'] = (0.0553*AU)/(0.657*RSUN) # normalised semimajor axis 
    syspars['incl'] = 89.560 #88.9 # orbital inclination (degrees)
